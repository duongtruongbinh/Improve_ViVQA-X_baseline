...
def get_nlg_scores(references, hypotheses, device='cuda'):
    ...
    P, R, F1 = bert_score(hypotheses, [refs[0] for refs in references], lang='vi', device=device)
...
if __name__ == "__main__":
    evaluate("../../results/ViVQA-X_test_Qwen2.5-VL-7B-Instruct.json", output_file="evaluation_scores.json", device='cuda')
