    ...
    runs = [
        {
            'use_box': False,
            'points': [[525, 625]],
            'output_image_path': 'images/vlai_output_visualization_points.png'
        },
        {
            'use_box': True,
            'box': [340, 450, 720, 840],  # (x1, y1) - top right corner, (x2, y2) - bottom left corner
            'output_image_path': 'images/vlai_output_visualization_box.png'
        }
    ]
